...
//         {/* Category Badge - Top */}
//         {poster.category && (
//           <Badge className="absolute left-3 top-3 text-xs backdrop-blur-md bg-white/90 dark:bg-gray-900/90 text-gray-900 dark:text-white border-0 shadow-lg z-10 ">
//             {poster.category}
//           </Badge>
//         )}
...
//             <Badge
//               variant="destructive"
//               className="text-sm px-6 py-2 shadow-lg"
//             >
//               Out of Stock
//             </Badge>
//           </div>
...
//         <div className="absolute inset-x-0 bottom-0 p-4 translate-y-2 group-hover:translate-y-0 transition-transform duration-500 z-10">
//           {/* Title */}
...
//         {/* Corner Accent */}
//         <div className="absolute top-0 right-0 w-0 h-0 border-t-[40px] border-t-transparent border-r-[40px] border-r-white/10 dark:border-r-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
//       </div>

//       {/* Compact Info Below Image */}
//       <div className="mt-3 px-1">
//         <h3 className="text-sm md:text-base font-semibold text-gray-900 dark:text-gray-100 line-clamp-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
//           {poster.title}
//         </h3>
...
//               {poster.stock > 0 ? `${poster.stock} left` : "Out of stock"}
//             </p>
//           )}
//         </div>
//       </div>
